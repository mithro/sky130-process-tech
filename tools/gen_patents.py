...
def scope_and_completeness(fams: list[dict]) -> list[str]:
    ...
    return [
        ...
        "its technique, except two (process/UV-induced-charging damage protection during BEOL processing), "
        "which the index had no other example of and which are added below instead. Of the round-4 Weebit "
