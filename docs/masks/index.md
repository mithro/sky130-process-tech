...
| {ref}`LVTNM <step-014>` | Low Vt Nch\*, {ref}`LVTNM <mask-lvtnm>` — `X` | `clvtnm` mask 25:0; drawing 25:44, mask add 25:43, mask drop 25:42 | `lvtn` 125:44 | {ref}`LVTNI <step-015>`; strip {ref}`LVTNIS <step-016>` | `LVTNMCD` 0.38 / `LVTNMCDSP` 0.38 |
...
| {ref}`RRPM <step-052>`, mask page {ref}`RRPM <mask-rrpm>` | *not listed* | none | `rpm` 86:20, alone or less `urpm` 79:20 *(inference)* | {ref}`PRI <step-053>`; strip {ref}`PRIS <step-054>` | none listed |
| {ref}`URPM <step-055>`, mask page {ref}`URPM <mask-urpm>` | *not listed* | none | `urpm` 79:20 *(inference)* | {ref}`UPRI <step-056>`; strip {ref}`UPRIS <step-057>` | none listed |
...
| {ref}`NPCM <step-078>` | Nitride Poly Cut, {ref}`NPCM <mask-npcm>` — `X` | `cnpc` mask 49:0; drawing 44:20 | `npc` 95:20 | {ref}`NPCME <step-079>` | `NPCMCD` 0.27 / `NPCMCDSP` 0.27 |
| {ref}`PSDM <step-081>` | P+ Implant, {ref}`PSDM <mask-psdm>` — `X` | `cpsdm` mask 32:0; drawing 31:20, mask add 31:21, mask drop 31:22 | `psdm` 94:20 | {ref}`PSDI <step-082>`, {ref}`2PSDI <step-083>`; strip {ref}`PDIS <step-084>` | `PSDMCD` 0.38 / `PSDMCDSP` 0.38 |
| {ref}`NSDM <step-085>` | N+ Implant, {ref}`NSDM <mask-nsdm>` — `X` | `cnsdm` mask 30:0; drawing 29:20, mask add 29:21, mask drop 29:22 | `nsdm` 93:44 | {ref}`NSDI <step-086>`; strip {ref}`NSDIS <step-087>` | `NSDMCD` 0.38 / `NSDMCDSP` 0.38 |
...
* {ref}`US 6,379,849 B1 <patent-gp24795638>` — Method for forming binary intensity masks (2000)
* {ref}`US 6,849,549 B1 <patent-gp34080863>` — Method for forming dummy structures for improved CMP and reduced capacitance (2003)
<!-- index-links:end -->
