...
* Paper index: five held items; two bibliographic services refuse
  scripted access.
* Decisions left to the owner: the policy wording in the first commits
  of the history (no identifiers; rewriting would need a force-push of
  `main`); whether passages from patents in force should stay collapsed
