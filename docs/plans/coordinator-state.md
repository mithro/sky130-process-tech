...
| `topic/rd-figures-s2` | W1c series S2 wells (steps 014–034): reviewed, fix round running (faded layers as outlines, pattern-only implant overlay, one-panel rule, placement rule) | Opus | fixing |
