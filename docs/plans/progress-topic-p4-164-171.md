...
| 169-L4 | Medium(cap) | deferred -> closed on `topic/metal-cap` | Danzl annotation on 168-pdm.md rewritten there |
...
| (n/a) | n/a | deferred -> closed on `topic/metal-cap` | 170-ally.md:57-58 rewritten there |
