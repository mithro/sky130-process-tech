...
- [x] (reports done 2026-09-13; test-tile integration reviewed and merged 2026-09-13; HV, 1.8 V and passives integration to follow) Raw-data research: four read-only agents reviewing https://github.com/google/skywater-pdk-sky130-raw-data (docs and test tile; 1.8 V MOSFETs; HV, native and ESD devices; passives, BJTs and varactors); reports propose additions to step, category and index pages
