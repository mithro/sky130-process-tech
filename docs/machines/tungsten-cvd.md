...
|---:|---|---|---|
| 99 | {ref}`WDEP <step-099>` | Blanket CVD W deposition | main |
| 110 | {ref}`WDEP2 <step-110>` | Blanket CVD W deposition | main |
| 121 | {ref}`WDEP3 <step-121>` | Blanket CVD W deposition | main |
| 132 | {ref}`WDEP4 <step-132>` | Blanket CVD W deposition | main |
| 147 | {ref}`WDEP5 <step-147>` | Blanket CVD W deposition | main |
:::
<!-- step-tables:end -->
...
* {ref}`Process for CVD deposition of tungsten layer on semiconductor wafer <patent-gp23576244>` — US 5,028,565 A (1989)
* {ref}`Gas-based backside protection during substrate processing <patent-gp24212535>` — US 5,374,594 A (1990)
* {ref}`Method for making reliable selective via fills <patent-gp22085430>` — US 5,366,929 A (1993)
* {ref}`Isolation of incompatible processes in a multi-station processing chamber <patent-gp22616474>` — US 6,319,553 B1 (1998)
