...
* {ref}`US 5,186,718 A <patent-gp26998663>` — Staged-vacuum wafer processing system and method (1989)
* {ref}`US 5,330,628 A <patent-gp23870722>` — Collimated deposition apparatus and method (1990)
...
* {ref}`US 5,346,578 A <patent-gp25518280>` — Induction plasma source (1992)
* {ref}`US 5,707,498 A <patent-gp24741421>` — Avoiding contamination from induction coil in ionized sputtering (1996)
...
* {ref}`US 6,969,448 B1 <patent-gp23892778>` — Method for forming a metallization structure in an integrated circuit (1999)
<!-- index-links:end -->
