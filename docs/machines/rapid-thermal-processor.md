...
|---:|:---|:---|:---|
| 34 | {ref}`RTAI <step-034>` | Pre-gate oxide anneal | main |
| 47 | {ref}`LVGOX <step-047>` | Gate oxidation | main |
| 63 | {ref}`IOX45 <step-063>` | Implant oxidation | main |
| 75 | {ref}`TIPRTAD <step-075>` | RTA tip activation | main |
| 88 | {ref}`RTAD <step-088>` | RTA source drain implant anneal | main |
| 92 | {ref}`RTAD2 <step-092>` | RTA source drain anneal | main |
| 98 | {ref}`CSIL <step-098>` | Contact silicidation | main |
| 10 | {ref}`LINOX <step-010>` | LINOX oxidation | alternative |
| 11 | {ref}`FILOX <step-011>` | Fill oxide deposition | alternative |
| 40 | {ref}`ONO <step-040>` | ONO stack oxidation | alternative |
| 43 | {ref}`GOX100 <step-043>` | Gate oxidation | alternative |
| 96 | {ref}`ALLY1 <step-096>` | Alloy 1 | alternative |
| 170 | {ref}`ALLY <step-170>` | Alloy | alternative |
:::
<!-- step-tables:end -->
