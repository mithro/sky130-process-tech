...
|---:|:---|:---|:---|
| 5 | {ref}`STINITE <step-005>` | Shallow trench nitride etch | main |
| 42 | {ref}`ONOME <step-042>` | ONO mask etch | main |
| 77 | {ref}`SPE <step-077>` | Spacer nitride etch | main |
| 79 | {ref}`NPCME <step-079>` | Nitride poly cut mask etch | main |
| 94 | {ref}`LICM1E <step-094>` | Local interconnect contact mask etch | main |
...
| 166 | {ref}`NSME <step-166>` | Nitride seal mask etch | main |
| 169 | {ref}`PDME <step-169>` | Pad mask etch | main |
| 36 | {ref}`TUNARCE <step-036>` | Tunnel mask ARC etch | alternative |
:::
<!-- step-tables:end -->
