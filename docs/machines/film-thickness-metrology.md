...
| Requirement at 130 nm | ITRS 2001 asks for an equivalent-oxide-thickness measurement precision of 0.0052 nm (3σ) in 2001, from a precision-to-tolerance ratio of 0.1 against a ±4 % process range.[^itrs-2001-met] |
