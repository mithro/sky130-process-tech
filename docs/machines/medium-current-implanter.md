...
| Eaton | 8250 | — | presented at IIT 1998[^harlan-1998] |
...
:::{table} The 21 steps above: number, code and name
:widths: 10 16 58 16

| Step | Code | Name | Role on this page |
|---:|:---|:---|:---|
| 15 | {ref}`LVTNI <step-015>` | Low Vt NMOS implantation | main |
| 19 | {ref}`NWI2 <step-019>` | NWI2 implant | main |
| 20 | {ref}`LVTPI <step-020>` | Low V P-channel implant | main |
| 23 | {ref}`PCHI <step-023>` | P-channel implant | main |
| 24 | {ref}`PNCHI <step-024>` | P-channel BF2 implant | main |
...
| 37 | {ref}`PTSI <step-037>` | Punch-through stop implant | main |
| 38 | {ref}`DEPI <step-038>` | Depletion implant | main |
| 45 | {ref}`NCHI <step-045>` | N-channel implant | main |
| 53 | {ref}`PRI <step-053>` | PRI implant splits | main |
| 56 | {ref}`UPRI <step-056>` | UPRI implant | main |
| 65 | {ref}`ASTI <step-065>` | As tip implant | main |
| 66 | {ref}`BHI <step-066>` | B halo implant | main |
| 69 | {ref}`HVASTI <step-069>` | HV As N-tip implant | main |
| 72 | {ref}`LDASTI <step-072>` | LD ASTI implant | main |
| 73 | {ref}`LDBHI <step-073>` | LD B halo implant | main |
| 83 | {ref}`2PSDI <step-083>` | 2nd P+ source drain implant | main |
| 18 | {ref}`NWI <step-018>` | N-well implant | alternative |
:::
<!-- step-tables:end -->
