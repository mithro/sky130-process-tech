...
|---:|---|---|---|
| 171 | {ref}`HPETEST <step-171>` | Electrical test | main |
| 40 | {ref}`ONO <step-040>` | ONO stack oxidation | main |
| 43 | {ref}`GOX100 <step-043>` | Gate oxidation | main |
| 47 | {ref}`LVGOX <step-047>` | Gate oxidation | main |
| 63 | {ref}`IOX45 <step-063>` | Implant oxidation | main |
| 96 | {ref}`ALLY1 <step-096>` | Alloy 1 | main |
| 98 | {ref}`CSIL <step-098>` | Contact silicidation | main |
| 108 | {ref}`CTME <step-108>` | Metal contact mask etch | main |
| 114 | {ref}`MM1E <step-114>` | Metal1 mask etch | main |
| 119 | {ref}`VIME <step-119>` | Via1 mask etch | main |
| 125 | {ref}`MM2E <step-125>` | Metal2 mask etch | main |
| 130 | {ref}`VIM2E <step-130>` | Via2 mask etch | main |
| 135 | {ref}`CAPILD <step-135>` | Capacitor ILD oxynitride deposition | main |
| 138 | {ref}`CAPME <step-138>` | Capacitor mask etch | main |
| 140 | {ref}`MM3E <step-140>` | Metal3 mask etch | main |
| 145 | {ref}`VIM3E <step-145>` | Via3 mask etch | main |
| 150 | {ref}`CAPILD2 <step-150>` | Capacitor ILD oxynitride deposition | main |
| 153 | {ref}`CAP2ME <step-153>` | Capacitor 2 mask etch | main |
| 155 | {ref}`MM4E <step-155>` | Metal4 mask etch | main |
| 160 | {ref}`VIM4E <step-160>` | Via4 (pad via) mask etch | main |
| 163 | {ref}`MM5E <step-163>` | Metal5 mask etch | main |
| 170 | {ref}`ALLY <step-170>` | Alloy | main |
:::
<!-- step-tables:end -->
