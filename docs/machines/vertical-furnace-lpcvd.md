...
|---:|:---|:---|:---|
| 3 | {ref}`ISONIT <step-003>` | Iso nitride deposition | main |
| 40 | {ref}`ONO <step-040>` | ONO stack oxidation | main |
| 48 | {ref}`SAGD <step-048>` | Single a-Si gate deposition | main |
| 58 | {ref}`GATENIT <step-058>` | Gate poly nitride deposition | main |
| 59 | {ref}`POC <step-059>` | Protective oxide cap | main |
| 76 | {ref}`SPNIT <step-076>` | Spacer nitride deposition | main |
| 80 | {ref}`SPOX <step-080>` | Spacer oxide deposition | alternative |
| 104 | {ref}`LINIT <step-104>` | Nitride cap deposition | alternative |
:::
<!-- step-tables:end -->
...
* {ref}`Vertical low pressure CVD apparatus with an adjustable nozzle <patent-gp17554170>` — US 5,503,678 A (1993)
...
* {ref}`Vertical LPCVD furnace with reversible manifold collar and method of retrofitting same <patent-gp25536403>` — US 5,800,616 A (1997)
