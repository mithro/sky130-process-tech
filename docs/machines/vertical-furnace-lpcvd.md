...
* {ref}`US 5,503,678 A <patent-gp17554170>` — Vertical low pressure CVD apparatus with an adjustable nozzle (1993)
...
* {ref}`US 5,800,616 A <patent-gp25536403>` — Vertical LPCVD furnace with reversible manifold collar and method of retrofitting same (1997)
