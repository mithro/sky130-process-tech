...
:::{table} The 20 steps above: number, code and name
:widths: 10 16 58 16

| Step | Code | Name | Role on this page |
|---:|:---|:---|:---|
| 58 | {ref}`GATENIT <step-058>` | Gate poly nitride deposition | main |
| 59 | {ref}`POC <step-059>` | Protective oxide cap | main |
| 80 | {ref}`SPOX <step-080>` | Spacer oxide deposition | main |
| 89 | {ref}`PSG <step-089>` | Sacrificial PSG deposition | main |
| 91 | {ref}`NCAPOX <step-091>` | Cap oxide deposition | main |
| 104 | {ref}`LINIT <step-104>` | Nitride cap deposition | main |
| 105 | {ref}`NILD2 <step-105>` | ILD oxide deposition | main |
| 115 | {ref}`NILD3 <step-115>` | ILD oxide deposition | main |
| 117 | {ref}`NCAPOX3 <step-117>` | CAPOX deposition | main |
| 126 | {ref}`NILD4 <step-126>` | ILD oxide deposition | main |
| 128 | {ref}`NCAPOX4 <step-128>` | CAPOX deposition | main |
| 135 | {ref}`CAPILD <step-135>` | Capacitor ILD oxynitride deposition | main |
| 141 | {ref}`NILD5 <step-141>` | ILD oxide deposition | main |
| 143 | {ref}`NCAPOX5 <step-143>` | CAPOX deposition | main |
| 150 | {ref}`CAPILD2 <step-150>` | Capacitor ILD oxynitride deposition | main |
| 156 | {ref}`NILD6 <step-156>` | ILD oxide deposition | main |
| 158 | {ref}`NCAPOX6 <step-158>` | CAPOX deposition | main |
| 164 | {ref}`NFUSOX <step-164>` | Fuse oxide deposition | main |
| 167 | {ref}`NTSD <step-167>` | Nitride topside deposition | main |
| 76 | {ref}`SPNIT <step-076>` | Spacer nitride deposition | alternative |
:::
<!-- step-tables:end -->
...
* {ref}`Thermal CVD/PECVD reactor and use for thermal chemical vapor deposition of silicon dioxide and in-situ multi-step planarized process <patent-gp25481509>` — US 5,000,113 A (1986)
* {ref}`Methods and apparatus for cleaning surfaces in a substrate processing system <patent-gp25007997>` — US 5,812,403 A (1996)
