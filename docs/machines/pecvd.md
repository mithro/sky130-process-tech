...
* {ref}`US 5,000,113 A <patent-gp25481509>` — Thermal CVD/PECVD reactor and use for thermal chemical vapor deposition of silicon dioxide and in-situ multi-step planarized process (1986)
* {ref}`US 5,812,403 A <patent-gp25007997>` — Methods and apparatus for cleaning surfaces in a substrate processing system (1996)
