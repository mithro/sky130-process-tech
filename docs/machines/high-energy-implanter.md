...
* {ref}`US 4,667,111 A <patent-gp24955302>` — Accelerator for ion implantation (1985)
...
* {ref}`US 5,760,409 A <patent-gp25134219>` — Dose control for use in an ion implanter (1996)
...
* {ref}`US 6,653,803 B1 <patent-gp24331908>` — Integrated resonator and amplifier system (2000)
