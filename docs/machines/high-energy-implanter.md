...
:::{table} The 8 steps above: number, code and name
:widths: 10 16 58 16

| Step | Code | Name | Role on this page |
|---:|:---|:---|:---|
| 8 | {ref}`DNI <step-008>` | Deep N+ implant | main |
| 18 | {ref}`NWI <step-018>` | N-well implant | main |
| 19 | {ref}`NWI2 <step-019>` | NWI2 implant | main |
| 27 | {ref}`PWI <step-027>` | P-well implant | main |
| 28 | {ref}`PWI2 <step-028>` | PWI2 implant | main |
| 31 | {ref}`PWDEI1 <step-031>` | PWDEI1 implant | main |
| 32 | {ref}`PWDEI2 <step-032>` | PWDEI2 implant | main |
| 20 | {ref}`LVTPI <step-020>` | Low V P-channel implant | alternative |
:::
<!-- step-tables:end -->
...
* {ref}`Accelerator for ion implantation <patent-gp24955302>` — US 4,667,111 A (1985)
...
* {ref}`Method for cmos latch-up improvement by mev billi (buried implanted layer for laternal isolation) plus buried layer implantation <patent-gp25236318>` — US 5,821,589 A (1997)
* {ref}`Integrated resonator and amplifier system <patent-gp24331908>` — US 6,653,803 B1 (2000)
