...
* {ref}`US 5,498,308 A <patent-gp22748832>` — Plasma asher with microwave trap (1994)
...
* {ref}`US 6,179,973 B1 <patent-gp26812562>` — Apparatus and method for controlling plasma uniformity across a substrate (1999)
* {ref}`US 6,350,353 B2 <patent-gp23783296>` — Alternate steps of IMP and sputtering process to improve sidewall coverage (1999)
* {ref}`US 6,914,016 B2 <patent-gp25317682>` — HDP-CVD deposition process for filling high aspect ratio gaps (2001)
