...
* {ref}`Monitoring cleaning effectiveness of a cleaning system <patent-gp25357416>` — US 5,931,173 A (1997)
* {ref}`Extension of the useful life of a chemical bath used to process a substrate <patent-gp25524224>` — US 6,273,098 B1 (1997)
* {ref}`Centrifugal spray processor and retrofit kit <patent-gp24449421>` — US 7,305,999 B2 (2000)
