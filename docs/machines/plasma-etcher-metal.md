...
|---:|---|---|---|
| 103 | {ref}`LI1ME <step-103>` | Local interconnect 1 mask etch | main |
...
* {ref}`Tin etch process <patent-gp25274513>` — US 4,675,073 A (1986)
...
* {ref}`paper-grenci-2001a` — C. Grenci et al., ISSM 2001 (affiliation inference)
<!-- index-links:end -->
