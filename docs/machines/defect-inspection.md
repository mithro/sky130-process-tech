...
* {ref}`Automatic photomask inspection system and apparatus <patent-gp25400807>` — US 4,247,203 A (1978)
* {ref}`Scanning contaminant and defect detector <patent-gp22942562>` — US 4,378,159 A (1981)
* {ref}`Light collector for optical contaminant and flaw detector <patent-gp24235560>` — US 4,601,576 A (1983)
* {ref}`Two-phase optical inspection method and apparatus for defect detection <patent-gp26322164>` — US 5,699,447 A (1990)
* {ref}`Surface inspection system <patent-gp27502820>` — US 5,864,394 A (1994)
* {ref}`Indentification of the composition of particles in a process chamber <patent-gp25430292>` — US 6,015,718 A (1997)
* {ref}`Sample inspection system <patent-gp25464477>` — US 6,201,601 B1 (1997)
* {ref}`Contact monitor, method of forming same and method of analyzing contact-, via-and/or trench-forming processes in an integrated circuit <patent-gp26769194>` — US 6,121,156 A (1998)
...
* {ref}`paper-sajoto-1999a` — D. Sajoto et al., ISSM 1999 (affiliation inference)
<!-- index-links:end -->
