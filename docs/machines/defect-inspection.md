...
* {ref}`US 4,247,203 A <patent-gp25400807>` — Automatic photomask inspection system and apparatus (1978)
* {ref}`US 4,378,159 A <patent-gp22942562>` — Scanning contaminant and defect detector (1981)
