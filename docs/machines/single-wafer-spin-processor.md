...
|---:|:---|:---|:---|
| 39 | {ref}`TUNME <step-039>` | Tunnel mask etch | main |
| 46 | {ref}`GOXETCH <step-046>` | Low V gate oxide etch | main |
| 60 | {ref}`BFR <step-060>` | Backside film removal | main |
| 95 | {ref}`SACETCH <step-095>` | Sacrificial etch | main |
| 12 | {ref}`CMPNIT <step-012>` | CMP over nitride | also for a clean |
| 33 | {ref}`PWDEIS <step-033>` | PWDEIS implant strip | also for a clean |
| 108 | {ref}`CTME <step-108>` | Metal contact mask etch | also for a clean |
| 111 | {ref}`WCMP2 <step-111>` | W CMP for metal contact | also for a clean |
| 116 | {ref}`CMPM <step-116>` | CMP over metal1 | also for a clean |
| 119 | {ref}`VIME <step-119>` | Via1 mask etch | also for a clean |
| 122 | {ref}`WCMP3 <step-122>` | W CMP for via1 | also for a clean |
| 127 | {ref}`CMPM2 <step-127>` | CMP over metal2 | also for a clean |
| 130 | {ref}`VIM2E <step-130>` | Via2 mask etch | also for a clean |
| 133 | {ref}`WCMP4 <step-133>` | W CMP for via2 | also for a clean |
| 142 | {ref}`CMPM3 <step-142>` | CMP over metal3 | also for a clean |
| 145 | {ref}`VIM3E <step-145>` | Via3 mask etch | also for a clean |
| 148 | {ref}`WCMP5 <step-148>` | W CMP for via3 | also for a clean |
| 157 | {ref}`CMPM4 <step-157>` | CMP over metal4 | also for a clean |
:::
<!-- step-tables:end -->
