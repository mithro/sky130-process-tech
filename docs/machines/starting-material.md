...
|---:|---|---|---|
| 1 | {ref}`SMAT <step-001>` | Starting material | main |
:::
<!-- step-tables:end -->
...
* {ref}`Method of making reference surface markings on semiconductor wafers by laser beam <patent-gp6203424>` — US 4,522,656 A (1983)
* {ref}`Method and device for sorting wafers <patent-gp7697942>` — US 6,747,230 B2 (2001)
