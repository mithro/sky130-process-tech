...
* {ref}`US 4,522,656 A <patent-gp6203424>` — Method of making reference surface markings on semiconductor wafers by laser beam (1983)
* {ref}`US 6,747,230 B2 <patent-gp7697942>` — Method and device for sorting wafers (2001)
