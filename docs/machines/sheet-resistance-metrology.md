...
* {ref}`US 4,579,463 A <patent-gp24451614>` — Detecting thermal waves to evaluate thermal parameters (1984)
* {ref}`US 4,703,252 A <patent-gp24828889>` — Apparatus and methods for resistivity testing (1985)
* {ref}`US 4,854,710 A <patent-gp24841884>` — Method and apparatus for evaluating surface and subsurface features in a semiconductor (1985)
<!-- index-links:end -->
