...
:::{dropdown} All 46 steps as one line of links (checked against the index)
...
* {ref}`Detecting thermal waves to evaluate thermal parameters <patent-gp24451614>` — US 4,579,463 A (1984)
* {ref}`Apparatus and methods for resistivity testing <patent-gp24828889>` — US 4,703,252 A (1985)
* {ref}`Method and apparatus for evaluating surface and subsurface features in a semiconductor <patent-gp24841884>` — US 4,854,710 A (1985)
<!-- index-links:end -->
