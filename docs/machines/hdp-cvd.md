...
* {ref}`US 6,200,412 B1 <patent-gp24412185>` — Chemical vapor deposition system including dedicated cleaning gas injection (1996)
...
* {ref}`US 6,030,881 A <patent-gp22109576>` — High throughput chemical vapor deposition process capable of filling high aspect ratio structures (1998)
