...
* **PECVD oxide system**, 200 mm: Applied Materials Producer or
...
* **TEOS** (liquid, vaporised) and **oxygen**, with **helium** carrier;[^wiki-teos]
  or **silane** and **N₂O** for the silane route.[^wiki-pecvd]
