...
**Related patents.** 16 families concern this page (12 unknown, 4 expired); see {ref}`patents-by-module` for the full, grouped list (families still in force or of unknown status are collapsed there too).
<!-- index-links:end -->
