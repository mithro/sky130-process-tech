...
**Related patents.** 25 families concern this page (15 unknown, 10 expired); see {ref}`patents-by-module` for the full, grouped list (families still in force or of unknown status are collapsed there too).
<!-- index-links:end -->
