...
:alt: Two enlarged cross-sections of a flat pale oxide over a thin hatched film and a thin purple pad, which stands on a larger tungsten plug. Before the step a violet resist with a narrow window lies on the oxide. After it the resist is gone and under the window a small hole with sloping walls, narrower at the bottom, goes down through the oxide and the hatched film to the pad.
:width: 560px
