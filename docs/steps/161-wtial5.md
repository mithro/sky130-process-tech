...
:::{figure} /_static/figures/beol-161-wtial5.svg
:alt: Two cross-sections of the upper films, one above the other, cut off at the bottom. Before the step two wide open holes go down through a flat pale oxide, one to a metal line and one to a raised thin plate. After it three films cover the whole top and fill the holes: a thin purple film lining the oxide, the walls and the floors, a very thick silver film that closes each hole, and another thin purple film, with a shallow dip over each hole.
:width: 560px
:name: fig-beol-161-wtial5
...
* {ref}`Multistep sputtering process for forming aluminum layer over stepped semiconductor wafer <patent-gp23997467>` — US 5,108,570 A (1990)
...
* {ref}`Method for filing substrate recesses using elevated temperature and pressure <patent-gp27450687>` — US 5,527,561 A (1991)
