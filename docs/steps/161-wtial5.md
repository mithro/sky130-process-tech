...
* {ref}`US 4,698,128 A <patent-gp25460564>` — Sloped contact etch process (1986)
* {ref}`US 5,108,570 A <patent-gp23997467>` — Multistep sputtering process for forming aluminum layer over stepped semiconductor wafer (1990)
...
* {ref}`US 5,527,561 A <patent-gp27450687>` — Method for filing substrate recesses using elevated temperature and pressure (1991)
* {ref}`US 5,308,415 A <patent-gp25546287>` — Enhancing step coverage by creating a tapered profile through three dimensional resist pull back (1992)
<!-- index-links:end -->
