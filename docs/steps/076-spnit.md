...
:::{figure} /_static/figures/sd-076-spnit.svg
:alt: Two enlarged cross-sections of one transistor edge, one above the other. Before the step a capped gate stands on a thin oxide, with doped layers in the silicon beside it. After it a new film of even thickness covers everything: the oxide beside the gate, the gate's sidewalls and its top.
:width: 560px
:name: fig-sd-076-spnit
