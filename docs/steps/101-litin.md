...
:alt: Two cross-sections of the wafer, one above the other. Before the step a flat oxide surface is broken by the tops of three metal-filled holes: two reach the silicon of the active areas and one, shallower, the top of the wide stack in the middle. After it a thin purple film of even thickness covers the whole flat surface and the tops of the three plugs.
:width: 560px
