...
* {ref}`US 4,821,085 A <patent-gp24930502>` — VLSI local interconnect structure (1985)
* {ref}`US 5,838,605 A <patent-gp24479530>` — Iridium oxide local interconnect (1996)
...
* {ref}`US 6,906,421 B1 <patent-gp34632364>` — Method of forming a low resistivity Ti-containing interconnect and semiconductor device comprising the same (1998)
