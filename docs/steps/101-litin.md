...
**Related patents.** 36 families concern this page (20 unknown, 16 expired); see {ref}`patents-by-module` for the full, grouped list (families still in force or of unknown status are collapsed there too).
<!-- index-links:end -->
