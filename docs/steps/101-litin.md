...
**Related patents.** 40 families concern this page (24 unknown, 16 expired); see {ref}`patents-by-module` for the full, grouped list (families still in force or of unknown status are collapsed there too).
<!-- index-links:end -->
