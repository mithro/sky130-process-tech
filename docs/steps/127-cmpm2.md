...
6. **Metrology.** Remaining oxide thickness over metal-2 test pads by
   ...
   method[^stine-1998]); scratch and particle inspection on the KLA AIT class (our reading of "AIT" in
   SkyWater's job posting);[^job-06] via-2 chain resistance
