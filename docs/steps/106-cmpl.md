...
4. **Endpoint.** Time plus post-polish thickness measurement — the
   ...
   and Holland's 1998 paper, by its abstract, discusses "many of the
   approaches that have been published".[^bibby-1998] Run-to-run control
