...
* {ref}`US 5,380,401 A <patent-gp21710466>` — Method to remove fluorine residues from bond pads (1993)
* {ref}`US 7,055,532 B2 <patent-gp34678118>` — Method to remove fluorine residue from bond pads (2003)
<!-- index-links:end -->
