...
:::{figure} /_static/figures/pass-169-pdme.svg
:alt: Two cross-sections of the upper films, one above the other, cut off at the bottom. Before the step a thick violet resist with one window covers a thick green film over two metal shapes. After it the resist is gone and, where the window was, the green film and the thin pale film under it have been cut away with vertical edges, leaving the top of the left-hand metal shape bare, while both films still cover its edges and the rest of the slice.
:width: 560px
:name: fig-pass-169-pdme
...
* {ref}`Method to remove fluorine residues from bond pads <patent-gp21710466>` — US 5,380,401 A (1993)
* {ref}`Method to remove fluorine residue from bond pads <patent-gp34678118>` — US 7,055,532 B2 (2003)
<!-- index-links:end -->
