...
* {ref}`Process for improved planarization of the passivation layers for semiconductor devices <patent-gp22827270>` — US 4,986,878 A (1988)
* {ref}`Fuse window with controlled fuse oxide thickness <patent-gp24070664>` — US 5,872,390 A (1995)
* {ref}`Method of etching a bond pad <patent-gp24743931>` — US 5,911,887 A (1996)
...
* {ref}`Method of forming a metal fuse on semiconductor devices <patent-gp32593189>` — US 6,835,642 B2 (2002)
