...
Before, the PWDEM resist over the whole slice; after, the resist gone and the oxide bare over both wells, ready for the anneal. The page assumes that the pad oxide is kept through the anneal, so it is drawn in place; whether it is kept is not stated publicly. The NMOS channel implant, the PMOS channel implant and the liner oxide are drawn faded. Not to scale.
:::
...
* [SkyWater, *Facilities & Capabilities*](<https://www.skywatertechnology.com/manufacturing/facilities-capabilities/>) — ashers; Akrion; DNS and FSI
  "HF/SC1/SC2".[^skw-01]
...
* [Wolf and Tauber, *Silicon Processing for the VLSI Era*, vol. 1](<https://openlibrary.org/isbn/9780961672164>) — wet
  cleaning.[^txt-02]
...
* [Kern, in Reinhardt and Kern (eds.), *Handbook of Silicon Wafer
  Cleaning Technology*](<https://doi.org/10.1016/b978-081551554-8.50004-5>) — the overview chapter on wet-cleaning chemistry
