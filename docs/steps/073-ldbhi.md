...
* {ref}`US 5,364,807 A <patent-gp19355404>` — Method for fabricating LDD transitor utilizing halo implant (1993)
* {ref}`US 5,372,957 A <patent-gp22246938>` — Multiple tilted angle ion implantation MOSFET method (1993)
* {ref}`US 5,595,919 A <patent-gp24414167>` — Method of making self-aligned halo process for reducing junction capacitance (1996)
* {ref}`US 6,238,982 B1 <patent-gp23113681>` — Multiple threshold voltage semiconductor device fabrication technology (1999)
* {ref}`US 6,630,385 B1 <patent-gp28675849>` — MOSFET with differential halo implant and annealing strategy (2001)
<!-- index-links:end -->
