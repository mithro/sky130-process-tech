...
:alt: Two enlarged cross-sections of one contact hole beside a transistor gate, one above the other. Before the step a hole with sloping walls goes down through a thin flat oxide and a dotted glass to the doped silicon. After it a thin purple film covers the flat top, the walls and the bottom of the hole; it is thickest in the lower corners, where the walls close in.
:width: 560px
