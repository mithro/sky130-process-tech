...
* {ref}`US 6,090,697 A <patent-gp26729228>` — Etchstop for integrated circuits (1997)
* {ref}`US 6,013,581 A <patent-gp21630827>` — Method for preventing poisoned vias and trenches (1998)
<!-- index-links:end -->
