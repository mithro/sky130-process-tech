...
:::{figure} /_static/figures/sd-084-pdis.svg
:alt: Two cross-sections of the wafer, one above the other. Before the step resist covers both active areas and leaves a window over a wide stack on the oxide-filled trench. After it the resist is gone and a thin oxide covers everything, as before the mask.
:width: 560px
...
* {ref}`Semiconductor device with outwardly tapered sidewall spacers and method for forming same <patent-gp22147006>` — US 6,255,180 B1 (1998)
