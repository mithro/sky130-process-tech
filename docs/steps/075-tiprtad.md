...
* {ref}`US 6,521,502 B1 <patent-gp24538683>` — Solid phase epitaxy activation process for source/drain junction extensions and halo regions (2000)
* {ref}`US 6,518,136 B2 <patent-gp24961682>` — Sacrificial polysilicon sidewall process and rapid thermal spike annealing for advance CMOS fabrication (2000)
* {ref}`US 6,803,297 B2 <patent-gp31992738>` — Optimal spike anneal ambient (2002)
* {ref}`US 6,897,131 B2 <patent-gp32659145>` — Advances in spike anneal processes for ultra shallow junctions (2002)
<!-- index-links:end -->
