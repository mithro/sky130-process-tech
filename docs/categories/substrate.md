...
* {ref}`US 5,851,887 A <patent-gp23168517>` — Deep sub-micron polysilicon gap formation (1994)
* {ref}`US 5,830,797 A <patent-gp24703979>` — Interconnect methods and apparatus (1996)
* {ref}`US 6,004,874 A <patent-gp24696949>` — Method for forming an interconnect (1996)
