...
**Related patents.** 28 families concern this page (14 unknown, 14 expired); see {ref}`patents-by-module` for the full, grouped list (families still in force or of unknown status are collapsed there too).
<!-- index-links:end -->
