...
* {ref}`Ultra-low particle semiconductor cleaner for removal of particle contamination and residues from surface oxide formation on semiconductor wafers <patent-gp24705136>` — US 6,004,399 A (1996)
...
* {ref}`High vapor plasma strip methods and devices to enhance the reduction of organic residues over metal surfaces <patent-gp22801618>` — US 6,372,150 B1 (1998)
