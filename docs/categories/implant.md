...
**Related patents.** 13 families concern this page (7 unknown, 6 expired); see {ref}`patents-by-module` for the full, grouped list (families still in force or of unknown status are collapsed there too).
<!-- index-links:end -->
