...
* {ref}`US 4,582,624 A <patent-gp15425124>` — Etchant composition (1983)
* {ref}`US 4,795,582 A <patent-gp16907918>` — Surface treating composition for micro processing (1986)
* {ref}`US 5,334,332 A <patent-gp24443399>` — Cleaning compositions for removing etching residue and method of using (1990)
* {ref}`US 5,722,442 A <patent-gp46252077>` — On-site generation of ultra-high-purity buffered-HF for semiconductor processing (1994)
