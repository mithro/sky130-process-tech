...
|---:|---|---|---|
| 12 | {ref}`CMPNIT <step-012>` | CMP over nitride | main |
| 90 | {ref}`CMPP <step-090>` | CMP over poly | main |
| 100 | {ref}`WCMPLI <step-100>` | W CMP for local interconnect | main |
| 106 | {ref}`CMPL <step-106>` | CMP polish over local interconnect | main |
| 111 | {ref}`WCMP2 <step-111>` | W CMP for metal contact | main |
| 116 | {ref}`CMPM <step-116>` | CMP over metal1 | main |
| 122 | {ref}`WCMP3 <step-122>` | W CMP for via1 | main |
| 127 | {ref}`CMPM2 <step-127>` | CMP over metal2 | main |
| 133 | {ref}`WCMP4 <step-133>` | W CMP for via2 | main |
| 142 | {ref}`CMPM3 <step-142>` | CMP over metal3 | main |
| 148 | {ref}`WCMP5 <step-148>` | W CMP for via3 | main |
| 157 | {ref}`CMPM4 <step-157>` | CMP over metal4 | main |
:::
<!-- step-tables:end -->
...
* {ref}`Polymeric polishing pad containing hollow polymeric microelements <patent-gp25461879>` — US 5,578,362 A (1992)
...
* {ref}`Carrier head with a flexible membrane for a chemical mechanical polishing system <patent-gp24997773>` — US 6,183,354 B1 (1996)
