...
* {ref}`US 5,303,558 A <patent-gp25448458>` — Thermal trap for gaseous materials (1992)
...
* {ref}`US 5,902,103 A <patent-gp18429343>` — Vertical furnace of a semiconductor manufacturing apparatus and a boat cover thereof (1995)
* {ref}`US 5,707,498 A <patent-gp24741421>` — Avoiding contamination from induction coil in ionized sputtering (1996)
* {ref}`US 6,170,428 B1 <patent-gp24728963>` — Symmetric tunable inductively coupled HDP-CVD reactor (1996)
* {ref}`US 6,121,161 A <patent-gp25360177>` — Reduction of mobile ion and metal contamination in HDP-CVD chambers using chamber seasoning film depositions (1997)
* {ref}`US 6,776,873 B1 <patent-gp32848879>` — Yttrium oxide based surface coating for semiconductor IC processing vacuum chambers (2002)
* {ref}`US 2004/0069224 A1 <patent-gp32068901>` — Cold trap for CVD furnace (2002)
<!-- index-links:end -->
