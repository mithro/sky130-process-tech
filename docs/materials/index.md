...
| `post-cmp-clean` | Post-CMP clean chemistry: dilute NH₄OH or TMAH, dilute HF, citric acid, surfactant; PVA brushes | {ref}`CMP consumable; wet chemical <material-cmp-consumables>` | Removal of slurry particles and metal contamination after oxide and tungsten polishes. | "AMAT Mirra CMP" with "Track ammonia clean" and "IPA clean";[^skw-01] the FY2023 10-K names "CMC Chemicals, Inc. (a subsidiary of Entegris) (process and chemical mechanical polishing chemicals)".[^sec-02] | {ref}`012 <step-012>`, {ref}`090 <step-090>`, {ref}`100 <step-100>`, {ref}`106 <step-106>`, {ref}`111 <step-111>`, {ref}`116 <step-116>`, {ref}`122 <step-122>`, {ref}`127 <step-127>`, {ref}`133 <step-133>`, {ref}`142 <step-142>`, {ref}`148 <step-148>`, {ref}`157 <step-157>` |
