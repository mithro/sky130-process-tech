...
| Sputter targets | {ref}`sputter-targets <material-sputter-targets>` | The three rows of *Class* "Sputter target" |
...
| Ozone (O₃) for TEOS oxide deposition | Precursor; oxidant | O₂/O₃ oxidant for the TEOS PSG route. | typical (not listed) | {ref}`089 <step-089>` |
...
| Ozonated water (O₃ in water) | {ref}`Wet chemical; oxidant <material-wet-chemicals>` | Ozonated-water pre-clean options. | typical (not listed) | {ref}`039 <step-039>`, {ref}`043 <step-043>` |
