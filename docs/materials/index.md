...
|-----|----------|-------|----------------------|--------------------------|----------------------------------------|
| `si-wafers` | Silicon wafers, 200 mm, p-type, polished bulk | {ref}`Substrate <material-substrates>` | Starting material of the flow. | "200 mm equipment";[^skw-01] suppliers in both filings (table above).[^sec-01][^sec-02] | {ref}`001 <step-001>` |
