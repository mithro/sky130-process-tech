...
| Hydrogen bromide (HBr), Br₂ | Etch gas | Silicon trench and gate etches; organic ARC open; bromine option for the second {term}`MiM <MiM capacitor>` plate etch; optional silicon-selective landing step in the ONO etch. | "HBR" on the DPSII entry; "HBr" on the Lam 9400 and 4400 entries.[^skw-01] | {ref}`006 <step-006>`, {ref}`036 <step-036>`, {ref}`042 <step-042>`, {ref}`062 <step-062>`, {ref}`153 <step-153>` |
