...
* {ref}`US 5,215,639 A <patent-gp27493788>` — Composite sputtering target structures and process for producing such structures (1984)
...
* {ref}`US 5,693,203 A <patent-gp27479272>` — Sputtering target assembly having solid-phase bonded interface (1992)
* {ref}`US 5,836,506 A <patent-gp23689967>` — Sputter target/backing plate assembly and method of making same (1995)
* {ref}`US 5,707,498 A <patent-gp24741421>` — Avoiding contamination from induction coil in ionized sputtering (1996)
* {ref}`US 6,605,199 B2 <patent-gp25537645>` — Textured-metastable aluminum alloy sputter targets and method of manufacture (2001)
<!-- index-links:end -->
