...
:::{table} SKY130 steps that use this class
:widths: 8 14 46 32

| Step | Code | Name | Role on this page |
|---:|---|---|---|
| 97 | {ref}`TI/TIN1 <step-097>` | IMP Ti/TiN deposition | main |
| 101 | {ref}`LITIN <step-101>` | TiN deposition | main |
| 109 | {ref}`TIN2 <step-109>` | IMP TiN deposition | main |
| 112 | {ref}`TIAL6 <step-112>` | CoTi/AlCu/TiW deposition | main |
| 120 | {ref}`TIN3 <step-120>` | IMP TiN deposition | main |
| 123 | {ref}`TIAL12 <step-123>` | AlCu 2/TiW deposition | main |
| 131 | {ref}`TIN4 <step-131>` | IMP TiN deposition | main |
| 134 | {ref}`WTIAL3 <step-134>` | AlCu 2/TiW deposition | main |
| 136 | {ref}`CAPTIW1 <step-136>` | Capacitor TiW deposition | main |
| 146 | {ref}`TIN5 <step-146>` | IMP TiN deposition | main |
| 149 | {ref}`WTIAL4 <step-149>` | AlCu 2/TiW deposition | main |
| 151 | {ref}`CAPTIW2 <step-151>` | Capacitor TiW deposition | main |
| 161 | {ref}`WTIAL5 <step-161>` | AlCu 2/TiW deposition | main |
:::
<!-- step-tables:end -->
