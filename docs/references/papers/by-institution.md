...
| Efabless | {ref}`paper-edwards-2020a`, {ref}`paper-zhang-2022a` |
| Escuela Politécnica Nacional | {ref}`paper-tarabata-2025a` |
| European Space Agency | {ref}`paper-rodriguez-ferrandez-2023a` |
| Facebook, Inc. | {ref}`paper-le-2021a` |
| Fermi National Accelerator Laboratory | {ref}`paper-beall-2026a` |
...
| Universidad Nacional del Sur | {ref}`paper-marin-2024a` |
| Universidad San Francisco de Quito | {ref}`paper-tarabata-2025a` |
| Universidad Técnica Federico Santa María | {ref}`paper-marin-2024a`, {ref}`paper-munoz-2026a` |
| Universitat Politècnica de Catalunya | {ref}`paper-rodriguez-ferrandez-2023a` |
...
| Yale University | {ref}`paper-jagielski-2024a` |
