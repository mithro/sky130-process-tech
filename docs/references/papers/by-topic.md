...
Test chips, test vehicles and structures for process or device evaluation.
...
Total ionising dose, single-event effects and radiation testing.

* {ref}`paper-rodriguez-ferrandez-2023a` — Ivan Rodriguez-Ferrandez et al., IOLTS 2023 (free copy)

(papers-topic-cryogenic)=
### Cryogenic operation

Operation, measurement or modelling below room temperature.
...
(papers-topic-floating-gate)=
### Floating-gate devices

Floating-gate devices built in the standard process.

* {ref}`paper-mathews-2024a` — Pranav Mathews et al., CICC 2024
* {ref}`paper-chen-2024a` — Matthew Chen et al., Electronics Letters 2024 (free copy)

(papers-topic-beol-integration)=
...
SRAM and other memory macros.

* {ref}`paper-fliesler-2008a` — Michael Fliesler et al., NVSMW/ICMTD 2008 (lineage inference)
* {ref}`paper-cirimelli-low-2023a` — Jesse Cirimelli-Low et al., ISCAS 2023 (free copy)
* {ref}`paper-hossain-2026a` — Md. Sajjad Hossain et al., arXiv 2026 (free copy)

(papers-topic-sensors)=
### Sensors

Sensor front ends and sensing systems.
...
(papers-topic-quantum)=
### Quantum

Circuits for quantum computing or quantum devices.

* {ref}`paper-castoria-2025a` — K. E. Castoria et al., arXiv 2025 (free copy)

(papers-topic-security)=
### Hardware security
...
(papers-topic-tooling)=
### Open-source tooling

Open-source design flows and generators as they relate to the process.
...
### Shuttle programmes and education

Papers about a shuttle programme or its educational use.

* {ref}`paper-tarabata-2025a` — Byron Tarabata et al., SBCCI 2025

(papers-topic-lineage-s8)=
### Cypress S8 lineage
