...
`verified` date). The index holds 524 families (1817 members in total). Every family's representative
record page was fetched; 1758 of the 1817 members have their own record page
fetched (1460 from Google Patents, 298 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 296 of the 524 families in this index
