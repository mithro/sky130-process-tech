...
`verified` date). The index holds 462 families (1754 members in total). Every family's representative
record page was fetched; 1695 of the 1754 members have their own record page
fetched (1460 from Google Patents, 235 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 234 of the 462 families in this index
