...
`verified` date). The index holds 432 families (1724 members in total). Every family's representative
record page was fetched; 1665 of the 1724 members have their own record page
fetched (1460 from Google Patents, 205 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 204 of the 432 families in this index
