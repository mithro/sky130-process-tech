...
`verified` date). The index holds 490 families (1783 members in total). Every family's representative
record page was fetched; 1724 of the 1783 members have their own record page
fetched (1460 from Google Patents, 264 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 262 of the 490 families in this index
