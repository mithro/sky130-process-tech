...
`verified` date). The index holds 376 families (1668 members in total). Every family's representative
record page was fetched; 1609 of the 1668 members have their own record page
fetched (1460 from Google Patents, 149 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 148 of the 376 families in this index
