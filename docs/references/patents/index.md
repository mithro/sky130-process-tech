...
`verified` date). The index holds 508 families (1801 members in total). Every family's representative
record page was fetched; 1742 of the 1801 members have their own record page
fetched (1460 from Google Patents, 282 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 280 of the 508 families in this index
