...
`verified` date). The index holds 366 families (1658 members in total). Every family's representative
record page was fetched; 1599 of the 1658 members have their own record page
fetched (1460 from Google Patents, 139 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 138 of the 366 families in this index
