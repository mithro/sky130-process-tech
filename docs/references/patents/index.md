...
`verified` date). The index holds 543 families (1836 members in total). Every family's representative
record page was fetched; 1777 of the 1836 members have their own record page
fetched (1460 from Google Patents, 317 from USPTO Patent Public
Search).
...
25 families because Google Patents stayed unreachable while
