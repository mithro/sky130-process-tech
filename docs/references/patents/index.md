...
`verified` date). The index holds 453 families (1745 members in total). Every family's representative
record page was fetched; 1686 of the 1745 members have their own record page
fetched (1460 from Google Patents, 226 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 225 of the 453 families in this index
