...
`verified` date). The index holds 394 families (1686 members in total). Every family's representative
record page was fetched; 1627 of the 1686 members have their own record page
fetched (1460 from Google Patents, 167 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 166 of the 394 families in this index
