...
`verified` date). The index holds 533 families (1826 members in total). Every family's representative
record page was fetched; 1767 of the 1826 members have their own record page
fetched (1460 from Google Patents, 307 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 305 of the 533 families in this index
