...
`verified` date). The index holds 472 families (1764 members in total). Every family's representative
record page was fetched; 1705 of the 1764 members have their own record page
fetched (1460 from Google Patents, 245 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 244 of the 472 families in this index
