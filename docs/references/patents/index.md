...
`verified` date). The index holds 403 families (1695 members in total). Every family's representative
record page was fetched; 1636 of the 1695 members have their own record page
fetched (1460 from Google Patents, 176 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 175 of the 403 families in this index
