...
`verified` date). The index holds 334 families (1626 members in total). Every family's representative
record page was fetched; 1567 of the 1626 members have their own record page
fetched (1460 from Google Patents, 107 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 106 of the 334 families in this index
...
Discovery methods recorded across the 334 families: 172 families `cited-in-docs`; 153 families `assignee-search`; 13 families `citing-seed`; 10 families `cited-by-seed`; 4 families `continuation-search`. A family can carry more than one method (reached more than one way), so these do not sum to the family count.
