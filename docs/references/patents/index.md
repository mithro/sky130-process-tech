...
`verified` date). The index holds 499 families (1792 members in total). Every family's representative
record page was fetched; 1733 of the 1792 members have their own record page
fetched (1460 from Google Patents, 273 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 271 of the 499 families in this index
