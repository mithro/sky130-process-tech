...
`verified` date). The index holds 385 families (1677 members in total). Every family's representative
record page was fetched; 1618 of the 1677 members have their own record page
fetched (1460 from Google Patents, 158 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 157 of the 385 families in this index
