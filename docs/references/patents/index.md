...
`verified` date). The index holds 354 families (1646 members in total). Every family's representative
record page was fetched; 1587 of the 1646 members have their own record page
fetched (1460 from Google Patents, 127 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 126 of the 354 families in this index
