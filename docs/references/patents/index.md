...
`verified` date). The index holds 515 families (1808 members in total). Every family's representative
record page was fetched; 1749 of the 1808 members have their own record page
fetched (1460 from Google Patents, 289 from USPTO Patent Public
Search).
...
rather than assumed ended, per the design's rule 3.
 Separately, 287 of the 515 families in this index
